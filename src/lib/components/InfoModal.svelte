<script lang="ts">
	...
	const visualizations = [
		{ img: 'distribution-diagram', title: 'Distribution Diagram', desc: 'Each flower is a speaker. Size shows words spoken, height shows turns taken.' },
		...
		<div class="modal-box max-w-4xl max-h-[90vh] p-0 overflow-y-auto">
			...
			<div class="relative px-8 py-6 overflow-hidden">
				...
				<div class="relative z-10">
					...
					<div class="mt-4 inline-flex items-center gap-2 bg-emerald-400/20 text-emerald-200 rounded-full px-3 py-1 text-sm border border-emerald-400/30">
			...
			<div class="px-8 py-6">
				...
				{:else if activeTab === 'upload'}
					<div class="space-y-6">
						<p class="text-gray-600">CSV or TXT files with conversation data. If transcript has start times, add MP4 video to link transcript with video.</p>
			...
			<div class="bg-gray-50 px-8 py-4 flex flex-wrap items-center justify-between gap-4 border-t border-gray-200">
				<div class="flex flex-wrap gap-3">
					<a href="https://youtu.be/_2_3ilMm4pQ" target="_blank" rel="noopener noreferrer" class="text-sm text-gray-600 hover:text-gray-900 inline-flex items-center gap-1">
						<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
					...
					<a href="https://forms.gle/3i1F74V6cy5Q8RHv5" target="_blank" rel="noopener noreferrer" class="text-sm text-gray-600 hover:text-gray-900 inline-flex items-center gap-1">
						<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
						</svg>
						Feedback
					</a>
					<a href="https://github.com/BenRydal/transcript-explorer" target="_blank" rel="noopener noreferrer" class="text-sm text-gray-600 hover:text-gray-900 inline-flex items-center gap-1">
				...
				<details class="relative">
					...
					<div class="absolute right-0 bottom-full mb-2 text-xs text-gray-500 text-left w-[90vw] max-w-[450px] bg-white border border-gray-200 rounded-lg p-3 shadow-lg space-y-1">
						<p>Example data from Mathematics Teaching and Learning to Teach (MTLT), University of Michigan (2010) and The Third International Mathematics and Science Study (TIMSS) 1999 Video Study.</p>
						<p><strong>Citation:</strong> Shapiro, B.R., Hall, R., Mathur, A. & Zhao, E. (2025). Exploratory Visual Analysis of Transcripts for Interaction Analysis in HCI. CHI '25. <a href="https://doi.org/10.1145/3706598.3713490" class="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">doi.org/10.1145/3706598.3713490</a></p>
					</div>
				</details>
			</div>
		</div>
